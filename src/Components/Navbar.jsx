...
const Navbar = ({ searchTerm, onSearchChange, setResults }) => {
  ...
  return (
    <nav className="max-w-screen bg-[#101214] h-10 md:h-14">
      <ul className="flex justify-between items-center h-full md:p-2 w-full md:gap-6">
        <li className="flex justify-center items-center h-12 w-[22%]">
          <p className="font-extrabold text-[#ffffff] md:text-3xl"><NavLink to="/" end>
            BOOKZ
          </NavLink></p>
        </li>
        <li className="flex justify-center items-center h-12 px-5 w-[63.33%]">
          <div className="w-full h-6 flex justify-end gap-2 items-center">
            <input
              ...
              className="md:w-[20%] w-[80%] focus:w-[80%] transition-all focus:duration-1000 ease-in-out rounded-xl h-6 outline-none p-2 text-black md:p-3 text-sm md:text-lg bg-[#FFFFFF]"
        ...
        <li className="flex justify-start gap-5 items-center h-12 w-[10.33%]">
...
const Navbar = ({searchTerm, onSearchChange, setResults}) => {
  ...
  return (
    <nav className="max-w-screen bg-black h-14">
      <ul className="flex justify-between items-center h-full p-2 w-full gap-6">
        ...
        <li className="flex justify-center items-center h-12 px-5 w-[63.33%]">
          <div className="w-full h-6 flex justify-end gap-2 items-center">
            <input type="text" value={searchTerm} onChange={handleSearchTerm} className="md:w-[20%] w-[80%] focus:w-[80%] transition-all focus:duration-1000 ease-in-out rounded-xl h-8 outline-none p-3 text-lg bg-gray-300" placeholder="Search Books..."/>
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#933e3e" className="size-6 cursor-pointer" onClick={handleSearch}><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M17 17L21 21" stroke="#fffafa" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M19 11C19 15.4183 15.4183 19 11 19C6.58172 19 3 15.4183 3 11C3 6.58172 6.58172 3 11 3C15.4183 3 19 6.58172 19 11Z" stroke="#fffafa" strokeWidth="2"></path> </g></svg>
          </div>
        </li>
